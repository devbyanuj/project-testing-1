...
import { SignupButton, LoginButton, DashboardButton } from '@/components/Buttons'
    ...
    <>
      ...
      >
        <div className="mb-12 text-center">
          <h1 className="text-5xl font-bold tracking-tight" style={{ color: 'var(--color-text)' }}>
        ...
        <p className="text-sm mt-16" style={{ color: 'var(--color-text-light)' }}>
