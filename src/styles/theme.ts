...
export const theme = {
  ...
  light: {
    colors: {
      ...
      shadow:
        "0 1px 3px 0 hsl(150 42% 20% / 0.10), 0 1px 2px -1px hsl(150 42% 20% / 0.10)",
      shadowMd:
        "0 4px 6px -1px hsl(150 42% 20% / 0.10), 0 2px 4px -2px hsl(150 42% 20% / 0.10)",
      shadowLg:
        "0 10px 15px -3px hsl(150 42% 20% / 0.10), 0 4px 6px -4px hsl(150 42% 20% / 0.06)",
    },
  },
  ...
  dark: {
    colors: {
      ...
      shadow:
        "0 1px 3px 0 hsl(150 50% 5% / 0.40), 0 1px 2px -1px hsl(150 50% 5% / 0.40)",
      shadowMd:
        "0 4px 6px -1px hsl(150 50% 5% / 0.40), 0 2px 4px -2px hsl(150 50% 5% / 0.40)",
      shadowLg:
        "0 10px 15px -3px hsl(150 50% 5% / 0.50), 0 4px 6px -4px hsl(150 50% 5% / 0.30)",
    },
  },
